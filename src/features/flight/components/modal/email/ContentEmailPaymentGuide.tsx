...
import { sendEmail, supportPayMail } from '~/apis/flight';
...
const ContentEmailPaymentGuide: React.FC<Props> = (props) => {
  const { handleClose, dataModal, isShowPaymentGuide } = props;
  const intl = useIntl();
...
export default ContentEmailPaymentGuide;
